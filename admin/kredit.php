...
$query_kredit=mysql_query("SELECT A.id_mobil,A.id_pembeli,A.uang_muka,A.angsuran,A.bulan,A.tanggal,B.kode_mobil,B.merk,C.id,C.nama_pembeli FROM paket_kredit A , mobil B,pembeli C WHERE A.id_mobil = B.kode_mobil AND A.id_pembeli = C.id");
                                     $no1=1;
